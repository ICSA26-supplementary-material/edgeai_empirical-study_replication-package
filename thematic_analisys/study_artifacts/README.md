# 2. 📂 File Overview — Study Artifacts
...
## 2.1 all_collected_fragments.csv

### **Purpose**

This file contains *all raw architectural fragments* extracted from the analyzed EdgeAI repositories. It serves as the
primary data source for the open coding phase and represents the full textual corpus used to generate codes, categories,
and final thematic guidelines.
...
* Alignment with standards (e.g., ISO/IEC 25010 and ISO/IEC 30141 mappings)
...
Researchers may use this dataset to:
...
This file is the bridge between “raw data” and the “thematic analysis input”.
